...
void setup()
{
  ...
  ledcSetup(0, 5000, 8);  // Setup channel 0 with a frequency of 5000Hz and 8-bit resolution
  ledcAttachPin(greenLedPin, 0);  // Attach greenLedPin to channel 0
...
void loop()                     // run over and over again
{
  ...
  if (finger.fingerID == 9) {
    ...
    if (finger.confidence >= 60) {
      ...
      makeIFTTTRequest();
      // Green LED and Buzzer for enrolled fingerprint
      digitalWrite(greenLedPin, HIGH);
      tone(buzzerPin, 1000, 1000);  // 1000Hz frequency for 500ms
